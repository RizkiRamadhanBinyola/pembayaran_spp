                            ...
                            <div class="table-responsive ">
                                <table class="table table-striped ">
                                    ...
                                    <tbody>
                                        ...
                                        $query = "SELECT * FROM siswa,kelas,jurusan,spp where siswa.id_kelas=kelas.id_kelas AND siswa.id_spp=spp.id_spp AND siswa.id_jurusan=jurusan.id_jurusan ORDER BY nisn ASC";
